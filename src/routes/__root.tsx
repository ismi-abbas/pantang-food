  ...
  head: () => ({
    meta: [
      ...
      { title: 'Pantang Food' },
      {
        name: 'description',
        content:
          'Pantang Food is a bilingual pantang recipe app for Malaysian mothers, redesigned with the impeccable editorial skill, dedicated recipe pages, installable PWA support, and Cloudflare D1-backed data.',
      },
